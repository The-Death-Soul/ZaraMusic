...
import ffmpeg
import requests
from ZZ.fonts import CHAT_TITLE
from PIL import Image, ImageDraw, ImageFont
from config import ASSISTANT_NAME, BOT_USERNAME, IMG_1, IMG_2, IMG_5
from ZZ.filters import command, other_filters
from ZZ.queues import QUEUE, add_to_queue
from Zara.main import call_py, user
from ZZ.utils import bash
...
async def generate_cover(thumbnail, title, userid, ctitle):
    ...
    image2 = Image.open("Zara/zaramusic.png")
    ...
    font = ImageFont.truetype("Zara/finalfont.ttf", 60)
    font2 = ImageFont.truetype("Zara/finalfont.ttf", 70)     
...
async def play(c: Client, m: Message):
    ...
    keyboard = InlineKeyboardMarkup(
                  [[
                      ...
                      InlineKeyboardButton("🍸Cʜᴀɴɴᴇʟ🍸", url=f"https://t.me/Luv_Vids"),
                      InlineKeyboardButton("🥂Group🥂", url=f"https://t.me/+TFNht-Xwon1lM2Y1"),
                  ],[
    ...
    if replied:
        ...
        if len(m.command) < 2:
         await m.reply_photo(
                    ...
                    [
                        [
                            InlineKeyboardButton("💧Channel💧", url=f"https://t.me/Luv_Vids"),
                            InlineKeyboardButton("🩸Support🩸", url=f"https://t.me/+TFNht-Xwon1lM2Y1")
                        ],
                        [
                            InlineKeyboardButton("🗑 Close", callback_data="cls")
                        ]
