...
from ZZ.decorators import sudo_users_only
from ZZ.filters import command
...
async def start_private(client: Client, message: Message):
 await message.reply_photo(
        photo=f"https://te.legra.ph/file/d3185c725b9ba69b3f339.jpg",
...
async def start_group(client: Client, message: Message):
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("🍸Sᴜᴘᴘᴏʀᴛ🍸", url=f"https://t.me/+TFNht-Xwon1lM2Y1"),
                InlineKeyboardButton(
                    "🥂Uᴘᴅᴀᴛᴇs🥂", url=f"https://t.me/Luv_Vids"
                ),
            ]
        ]
    )
